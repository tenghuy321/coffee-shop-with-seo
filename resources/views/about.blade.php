...
<div class="max-w-4xl mx-auto px-4 py-16">
    ...
    <p class="text-[#5f4b32] leading-relaxed">
        At Café Luxe, we pride ourselves on sourcing the finest beans from around the world.
        Our expert baristas craft each cup with care to ensure a rich, smooth experience.
    </p>
</div>
@endsection
